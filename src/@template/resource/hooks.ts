...
export const useSelectResourceFetchError = <T extends Resource = Resource>(resource: T) =>
    useSelector(selectResourceFetchError(resource));
export const useSelectResourceSetError = <T extends Resource = Resource>(resource: T) =>
    useSelector(selectResourceSetError(resource));
export const useSelectResourceUpdateError = <T extends Resource = Resource>(resource: T) =>
    useSelector(selectResourceUpdateError(resource));
export const useSelectResourceDeleteError = <T extends Resource = Resource>(resource: T) =>
    useSelector(selectResourceDeleteError(resource));
